...
from copulalab.base import Copula
from copulalab.elliptical import StudentCopula, fit_nu_for_t_copula


def find_marginal_cdf(x: np.array, **kwargs) -> Callable[[float], float]:
    """
